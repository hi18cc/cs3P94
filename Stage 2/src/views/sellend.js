...
import styles from './sellend.module.css'

const Sellend = (props) => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>Sell end - realEstateApp</title>
        <meta property="og:title" content="Sell end - realEstateApp" />
      </Helmet>
      <div
      ...
      >
        ...
        >
          ...
          <div className={styles['Links']}>
            <Link
              to="/how-it-works"
              className={` ${styles['Text04']} ${projectStyles['button-secondary']} ${projectStyles['navbar-Link']} ${projectStyles['button']} `}
            >
              How it works
            </Link>
            <Link
      ...
      <div className={styles['container1']}>
        <h1 className={styles['text05']}>
          ...
          <br></br>
          <span>back to our homepage.</span>
          <span></span>
        </h1>
        <Link
          to="/"
