...
import FeatureCard41 from '../components/feature-card4'
...
const HowItWorks = (props) => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>HowItWorks - realEstateApp</title>
        <meta property="og:title" content="HowItWorks - realEstateApp" />
      </Helmet>
      <div
      ...
      <div className={styles['Banner']}>
        <h1 className={styles['text05']}>Our Mission</h1>
      ...
      <div className={styles['Features']}>
        ...
        <div className={styles['container1']}>
          ...
          <div className={styles['container3']}>
            <img
              alt="image"
              src="https://businesspartnermagazine.com/wp-content/uploads/2021/02/How-to-Get-More-Clients-as-a-Real-Estate-Agent.jpg"
              loading="eager"
      ...
      <footer className={styles['Footer']}>
        <div className={styles['container4']}>
          <div className={styles['Logo1']}>
            ...
            />
            <span className={projectStyles['brand-Name']}>
              <span className={styles['text15']}>First</span>
              <span className={styles['text16']}>-</span>
              <span className={styles['text17']}>Homes</span>
            </span>
          </div>
          <div className={styles['LinksContainer']}>
            <div className={styles['Container5']}>
              <div className={styles['ProductContainer']}>
                <span className={styles['text18']}>Service</span>
                <Link to="/buy" className={styles['navlink3']}>
                  Buy
                </Link>
                <Link to="/sell" className={styles['navlink4']}>
                  <span>Sell</span>
                </Link>
              </div>
              <div className={styles['CompanyContainer']}>
                <span className={styles['text20']}>Company</span>
                <span className={styles['text21']}>About</span>
                <span className={styles['text22']}>Careers</span>
                <span className={styles['text23']}>Contact</span>
              </div>
            </div>
            <div className={styles['container6']}>
              <div className={styles['Contact']}>
                <span className={styles['text24']}>Contact Us</span>
                <a
              ...
              <div className={styles['Socials']}>
                <span className={styles['text25']}>Follow Us</span>
