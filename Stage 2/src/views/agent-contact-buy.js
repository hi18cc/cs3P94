...
import styles from './agent-contact-buy.module.css'

const AgentContactBuy = (props) => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>AgentContactBuy - realEstateApp</title>
        <meta property="og:title" content="AgentContactBuy - realEstateApp" />
      </Helmet>
      <div
...
export default AgentContactBuy
