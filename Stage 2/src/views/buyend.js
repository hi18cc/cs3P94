...
import styles from './buyend.module.css'

const Buyend = (props) => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>Buy end - realEstateApp</title>
        <meta property="og:title" content="Buy end - realEstateApp" />
      </Helmet>
      <div
      ...
      <div className={styles['container1']}>
        <h1 className={styles['text05']}>
          <span>
            Congratulations! Your details have been sent. We will be in touch
            with you.
          </span>
          <br></br>
          <span>
            You can simply hit the button below to make your way
            <span
          ...
          <br></br>
          <span>back to the listings page.</span>
          <span></span>
        </h1>
        <Link
          to="/browse"
      ...
      <footer className={styles['Footer']}>
        <div className={styles['container2']}>
          <div className={styles['Logo1']}>
            ...
            />
            <span className={projectStyles['brand-Name']}>
              <span className={styles['text13']}>First</span>
              <span className={styles['text14']}>-</span>
              <span className={styles['text15']}>Homes</span>
            </span>
          </div>
          <div className={styles['LinksContainer']}>
            <div className={styles['Container3']}>
              <div className={styles['ProductContainer']}>
                <span className={styles['text16']}>Service</span>
              ...
              <div className={styles['CompanyContainer']}>
                <span className={styles['text18']}>Company</span>
                <span className={styles['text19']}>About</span>
                <span className={styles['text20']}>Careers</span>
                <span className={styles['text21']}>Contact</span>
              </div>
            </div>
            <div className={styles['container4']}>
              ...
              <div className={styles['Socials']}>
                <span className={styles['text23']}>Follow Us</span>
