...
const Buy = (props) => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>Buy - realEstateApp</title>
        <meta property="og:title" content="Buy - realEstateApp" />
      </Helmet>
      <div
      ...
      >
        ...
        >
          ...
          <div className={styles['Links']}>
            <Link
              to="/how-it-works"
              className={` ${styles['Text04']} ${projectStyles['navbar-Link']} ${projectStyles['button-secondary']} ${projectStyles['button']} `}
            >
              How it works
            </Link>
            <Link
      ...
      <div className={styles['Hero']}>
        <img
          alt="image"
          src="/playground_assets/85-1500w.jpeg"
          className={styles['image1']}
        />
        <div className={styles['container1']}>
          <h1 className={styles['text05']}>Buying a home</h1>
          <h2 className={styles['text06']}>
            Everything you need to find a home meant for you, we have.
          </h2>
      ...
      <div id="buyinfo" className={styles['Features']}>
        <h1 className={styles['text19']}>
          <span>How it works</span>
        </h1>
        <span className={styles['text21']}>
          <span>
            Simply click on &apos;Get Started&apos; above or below and you will
            be presented with a series of options to better help and narrow down
        ...
        <div className={styles['container2']}>
          <FeatureCard1
            ...
            description="Enter a location you're looking for a house in"
            rootClassName="rootClassName1"
          ></FeatureCard1>
          <FeatureCard2
            title="Better refine your results"
            description="Use the dropdown menus in the filter selections to find better suited results"
            rootClassName="rootClassName1"
          ></FeatureCard2>
          <FeatureCard3
            title="Arrange your results accordingly "
            description="Use the sort tab to sort your results based on price or otherwise"
            rootClassName="rootClassName1"
          ></FeatureCard3>
          <FeatureCard4
            title="On the way to the finish line!"
            description="Once a house of interest is found, simply click on it to make your way to the final step of the process"
            rootClassName="rootClassName1"
          ></FeatureCard4>
        </div>
      </div>
      <footer className={styles['Footer']}>
        <div className={styles['container3']}>
          <div className={styles['Logo1']}>
            ...
            />
            <span className={projectStyles['brand-Name']}>
              <span className={styles['text25']}>First</span>
              <span className={styles['text26']}>-</span>
              <span className={styles['text27']}>Homes</span>
            </span>
          </div>
          <div className={styles['LinksContainer']}>
            <div className={styles['Container4']}>
              <div className={styles['ProductContainer']}>
                <span className={styles['text28']}>Service</span>
              ...
              <div className={styles['CompanyContainer']}>
                <span className={styles['text30']}>Company</span>
                <span className={styles['text31']}>About</span>
                <span className={styles['text32']}>Careers</span>
                <span className={styles['text33']}>Contact</span>
              </div>
            </div>
            <div className={styles['container5']}>
              <div className={styles['Contact']}>
                <span className={styles['text34']}>Contact Us</span>
                <a
                ...
                <a href="tel:1234567899" className={styles['link2']}>
                  +123 (4567) 890
                </a>
              </div>
              <div className={styles['Socials']}>
                <span className={styles['text35']}>Follow Us</span>
