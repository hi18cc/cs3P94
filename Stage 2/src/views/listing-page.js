...
const ListingPage = (props) => {
  return (
    <div className={styles['container']}>
      <Helmet>
        <title>Listing Page - realEstateApp</title>
        <meta property="og:title" content="Listing Page - realEstateApp" />
      </Helmet>
      <div
        ...
        >
          <Link to="/">
            <div className={styles['Logo']}>
              <img
                alt="image"
                src="/playground_assets/25-255811_house-key-png-contemporary-png-a-full-and-400h.png"
          ...
          <div className={styles['Links']}>
            ...
            <Link
              to="/buy"
              className={` ${styles['navlink1']} ${projectStyles['navbar-Link']} ${projectStyles['button-secondary']} ${projectStyles['button']} `}
            >
              Buy
            </Link>
            <Link
      ...
      <div className={styles['container01']}>
        <div className={styles['container02']}>
          <h1 className={styles['Heading']}>123 Address st</h1>
        </div>
        <div className={styles['container03']}>
          <span className={styles['text05']}>Area</span>
          <span className={styles['text06']}>|</span>
          <span className={styles['text07']}>City</span>
        </div>
        ...
        <div className={styles['container08']}>
          <h1 className={styles['Heading1']}>$500,000</h1>
          ...
          <span className={styles['text10']}>xx/xx/xxxx</span>
        </div>
        <div className={styles['container09']}>
          <div className={styles['container10']}>
            ...
            <span className={styles['text13']}>X</span>
          </div>
          <div className={styles['container11']}>
            <span className={styles['text14']}>
              <span>Bathrooms:</span>
            </span>
            <span className={styles['text16']}>X</span>
          </div>
          <div className={styles['container12']}>
            <span className={styles['text17']}>
              <span>sqft:</span>
            </span>
            <span className={styles['text19']}>XXX-XXX</span>
          </div>
          <div className={styles['container13']}>
            <span className={styles['text20']}>
              <span>Type:</span>
            </span>
            <span className={styles['text22']}>Detatched</span>
          </div>
          <div className={styles['container14']}>
            <span className={styles['text23']}>
              <span>Parking:</span>
            </span>
            <span className={styles['text25']}>X</span>
          </div>
        </div>
        <div className={styles['Separator']}></div>
        <div className={styles['container15']}>
          <h1 className={styles['Heading2']}>Home Details</h1>
        </div>
        <div className={styles['container16']}>
          <div className={styles['container17']}>
            <span className={styles['text26']}>Description</span>
          </div>
        ...
        <div className={styles['container19']}>
          <div className={styles['container20']}>
            <span className={styles['text29']}>Listing Brokerage</span>
          </div>
          <div className={styles['container21']}>
            <span className={styles['text30']}>
              <span>MLS® Listing</span>
            </span>
            <span className={styles['text32']}>X2547610</span>
          </div>
          <div className={styles['container22']}>
            ...
            <span className={styles['text35']}>
              RE/MAX Lorem ipsum INC., BROKERAGE
            </span>
          </div>
        </div>
        <Link
          to="/agent-contact-buy"
      ...
      <footer className={styles['Footer']}>
        <div className={styles['container23']}>
          <div className={styles['Logo1']}>
            ...
            />
            <span className={projectStyles['brand-Name']}>
              <span className={styles['text37']}>First</span>
              <span className={styles['text38']}>-</span>
              <span className={styles['text39']}>Homes</span>
            </span>
          </div>
          <div className={styles['LinksContainer']}>
            <div className={styles['Container24']}>
              <div className={styles['ProductContainer']}>
                <span className={styles['text40']}>Service</span>
              ...
              <div className={styles['CompanyContainer']}>
                <span className={styles['text42']}>Company</span>
                <span className={styles['text43']}>About</span>
                <span className={styles['text44']}>Careers</span>
                <span className={styles['text45']}>Contact</span>
              </div>
            </div>
            <div className={styles['container25']}>
              <div className={styles['Contact']}>
                <span className={styles['text46']}>Contact Us</span>
                <a
              ...
              <div className={styles['Socials']}>
                <span className={styles['text47']}>Follow Us</span>
